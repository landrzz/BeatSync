  ...
  return (
    <AppProviders>
      <Stack screenOptions={{ headerStyle: { backgroundColor: '#0f172a' }, headerTintColor: 'white', contentStyle: { backgroundColor: '#0f172a' } }}>
        <Stack.Screen name="index" options={{ title: 'Beat Sync Buddy' }} />
        <Stack.Screen name="(auth)" options={{ headerShown: false }} />
        <Stack.Screen name="playlists/[id]" options={{ title: '' }} />
        ...
        <Stack.Screen name="join" options={{ title: 'Join Playlist', headerShown: false }} />
      </Stack>
    </AppProviders>
  );
}
